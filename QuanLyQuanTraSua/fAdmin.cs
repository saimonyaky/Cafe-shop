...

{
    public partial class fAdmin : Form
    {
        ...
        {
            txbTableID.DataBindings.Add(new Binding("Text", dtgvTable.DataSource, "id", true, DataSourceUpdateMode.Never));//Tránh chuyển đổi dl từ txb về dtgv
        ...
        {
            txbCategoryID.DataBindings.Add(new Binding("Text", dtgvCategory.DataSource, "id", true, DataSourceUpdateMode.Never));//Tránh chuyển đổi dl từ txb về dtgv
